model TestFm
  ...
  Flight6DOF flight6DOF1(J = {{1285.31, 0, 0}, {0, 1824.93, 0}, {0, 0, 2666.893}}, angles(start = {0, 0, 0}), mass = 1043.26, omega(start = {0, 0, 1}), pos(start = {0, -1, 1000}), v(start = {1, 0, 0}))  annotation(
