...
import InterProcessCommunication.SharedMemory.*;
 ...
 Modelica.Mechanics.Translational.Components.SpringDamper springDamper1(c = 100, d = 0.1, s_rel0 = 1)  annotation(
...
equation
  ...
  connect(mass1.flange_a, speedSensor1.flange) annotation(
    Line(points = {{26, 4}, {26, 4}, {26, -36}, {12, -36}, {12, -36}}, color = {0, 127, 0}));
  connect(y, speedSensor1.v) annotation(
    Line(points = {{-28, -36}, {-9, -36}}, color = {0, 0, 127}));
  ...
  motorOutputValue = speedSensor1.v "The measured speed of the system is assigned to pidInputValue, which is written into the shared memory using SharedMemoryWrite Function";
