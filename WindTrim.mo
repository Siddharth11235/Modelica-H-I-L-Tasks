model WindTrim
  ...
  RealInput deltaE(start = -0.15625) annotation(
  ...
  RealInput thrust(start = 1112.82) annotation(
    Placement(visible = true, transformation(origin = {-110, 33}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-110, 33}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  //Thrust force = 1112.82;
  //12 states
  Real p(start = 0);
  Modelica.Blocks.Interfaces.RealOutput q(start = 0) annotation(
    Placement(visible = true, transformation(origin = {110, 33}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {110, 33}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  //Angular velocity
  Real r(start = 0);
  Real OMEGA[3, 3] = skew({p, q, r});
  //Skew symmetric matrix form of the angular velocity term
  Real V(start = 39.8858);
  Modelica.Blocks.Interfaces.RealOutput alpha(start = 0.1) annotation(
    Placement(visible = true, transformation(origin = {110, -33}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {110, -33}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  //Angle of attack
  Real beta(start = 0);
  Real x(start = 0);
...
//Yawing coeff
  ...
  annotation(
    experiment(StartTime = 0, StopTime = 500, Interval = 0.002),
