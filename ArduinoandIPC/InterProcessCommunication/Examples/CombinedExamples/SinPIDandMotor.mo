...
extends Modelica.Icons.Example;
 Modelica.Blocks.Continuous.PID PID( Td = 0, Ti = 10 ^ 20, k = 20)  annotation(
 ...
 Modelica.Blocks.Sources.Pulse pulse1(amplitude = 200, offset = 0, period = 20, startTime = 0) annotation(
