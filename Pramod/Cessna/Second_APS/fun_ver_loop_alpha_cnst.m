function [ dydt] =fun_ver_loop_alpha_cnst( t,y )
alpharad=y(2);
g = 9.8;
rho = 1.225;
%q=0
...
C_Z = -C_D*sin(alpharad) - C_L*cos(alpharad)
 ...
 y(3)=(-g/y(1)+.5*rho*y(1)^2*S_ref*C_L/(m*y(1))+T*sin(y(2))/(m*y(1)));
