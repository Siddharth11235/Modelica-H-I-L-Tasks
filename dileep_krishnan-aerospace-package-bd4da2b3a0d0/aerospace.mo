...
/* Accelerations */
  ...
  class Examples
    ...
    equation
      connect(incidenceSideslipandAirspeed1.alpha, forceInBodyAxis1.alpha) annotation(
        Line(points = {{88, 0}, {86, 0}, {86, -12}, {-78, -12}, {-78, 52}, {-66, 52}, {-66, 68}, {-66, 68}}, color = {0, 0, 127}));
      connect(incidenceSideslipandAirspeed1.beta, forceInBodyAxis1.beta) annotation(
        Line(points = {{94, 0}, {94, 0}, {94, -16}, {-82, -16}, {-82, 58}, {-68, 58}, {-68, 68}, {-68, 68}}, color = {0, 0, 127}));
      connect(forceInBodyAxis1.EulerAngles, sixDOFEoM1.EulerAngles) annotation(
        Line(points = {{-72, 68}, {-72, 68}, {-72, 38}, {-24, 38}, {-24, 28}, {68, 28}, {68, 58}, {48, 58}, {48, 58}}, color = {0, 0, 127}, thickness = 0.5));
      ...
      connect(forceInBodyAxis1.Forces_w, aerodynamicForcesandMoments1.Forces) annotation(
        Line(points = {{-62, 68}, {-62, 68}, {-62, 32}, {-58, 32}, {-58, 28}, {-58, 28}}, color = {0, 0, 127}, thickness = 0.5));
      connect(mux61.y, aerodynamicForcesandMoments1.Coefficients) annotation(
        Line(points = {{16, -42}, {28, -42}, {28, -14}, {-60, -14}, {-60, 8}, {-58, 8}}, color = {0, 0, 127}, thickness = 0.5));
...
/* Outputs */
    ...
    model CessnaWithTrim
      ...
      Modelica.Blocks.Sources.Constant Aileron annotation(
        Placement(visible = true, transformation(origin = {-84, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Blocks.Sources.RealExpression realExpression1(y = if time > 10 and time < 11 then  -0.01304370748 else -0.0306583) annotation(
        Placement(visible = true, transformation(origin = {-88, 34}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    equation
      connect(realExpression1.y, cessnaAircraft1.Elevator) annotation(
        Line(points = {{-76, 34}, {-34, 34}, {-34, 26}, {10, 26}, {10, 26}}, color = {0, 0, 127}));
