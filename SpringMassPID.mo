model SpringMassPID
  ...
  Modelica.Blocks.Continuous.PID PID(Nd = 20, Td = 0.5, Ti = 0.1, k = 20)  annotation(
    Placement(visible = true, transformation(origin = {-34, 4}, extent = {{-8, -8}, {8, 8}}, rotation = 0)));
  ...
  Modelica.Blocks.Sources.Pulse pulse1(amplitude = 50, period = 20, startTime = 10)  annotation(
