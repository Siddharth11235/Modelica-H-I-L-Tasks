...
4). Go to the directory (RaspberryPi/InterProcessCommunication/Resources/Include/) and open file Serial_SHM.c.<br /> 
...
8). Now search for librt.so and librt.a files in system files of your PC’s and copy them.<br /> 
9). Open directory containing the model and go to the directory (RaspberryPi/InterProcessCommunication/Resources/Library/). Paste librt.so and librt.a files there replacing the existing files. <i><u>This is an important step, do not skip this</u></i>.<br />
